<template>
  <form @submit.prevent="$emit('update-region', { sido, gugun })" class="mb-4 d-flex gap-2">
    <input type="hidden" :value="sido" />

    <select v-model="gugun" class="form-select select-short">
  ...
  data() {
    return {
      ...
      areaData: {
        ...
        "대전" : ["대덕구","동구","서구","유성구","중구"], 
        "대구" : ["남구","달서구","동구","북구","서구","수성구","중구","달성군", "군위군군"],
        "광주" : ["광산구","남구","동구","북구","서구"],
        ...
        "충청남도" : ["계룡시","공주시","논산시","보령시","서산시","아산시","천안시","금산군","당진시","부여군","서천군","연기군","예산군","청양군","태안군","홍성군"],
